"""
Django's settings for myapp project.
...
SECRET_KEY = 'django-insecure-&z6-+(ju)v6v929q^^xa9kbedn-_fcfu3zw!7$^eesz^b&n0e3'
...
ADMIN_REORDER = (
    ...
    # Rename app
    # {'app': 'business', 'label': 'مدیریت کافه و منو'},

    # Reorder app models
    {'app': 'business', 'label': 'مدیریت کافه و منو', 'models': ('business.Cafe', 'business.Menu')},
    {'app': 'business', 'label': 'مدیریت کاربران', 'models': ('auth.User',
